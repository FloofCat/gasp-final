...
class ORPO:
    ...
    def train_finetuned(self, dataset_path):
        ...
        self.suffix_llm.model.save_pretrained(f"./gasp-reminder-2/models/{self.blackbox_name}_orpo")
        self.suffix_llm.tokenizer.save_pretrained(f"./gasp-reminder-2/models/{self.blackbox_name}_orpo")
