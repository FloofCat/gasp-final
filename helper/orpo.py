...
class ORPO:
    ...
    def train(self, dataset_path):
        ...
        self.suffix_llm.model.save_pretrained(f"./gasp-llama-2-7b/models/{self.blackbox_name}_orpo")
        self.suffix_llm.tokenizer.save_pretrained(f"./gasp-llama-2-7b/models/{self.blackbox_name}_orpo")
